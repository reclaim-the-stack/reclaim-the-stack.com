...
function TopLevelNavItem({ href, children }) {
  return (
    <li className="md:hidden">
      <Link
        href={href}
        className="block py-1 text-sm text-stone-600 transition hover:text-stone-900 dark:text-stone-400 dark:hover:text-white"
      >
        {children}
      </Link>
    </li>
...
export const navigation = [
  {
    ...
    links: [
      ...
      { title: 'Production Checklist', href: '/docs/kubernetes-platform/production-checklist' },
    ],
  },
  {
    title: 'Platform Components',
    links: [
      { title: 'Platform Components', href: '/docs/platform-components/introduction' },
      { title: 'Gitops: ArgoCD', href: '/docs/platform-components/gitops-argocd' },
      { title: 'Ingress: Cloudflared', href: '/docs/platform-components/ingress-cloudflared' },
      { title: 'PostgreSQL', href: '/docs/platform-components/postgresql-operator' },
      { title: 'Redis', href: '/docs/platform-components/redis-operator' },
      { title: 'Elasticsearch', href: '/docs/platform-components/elasticsearch-operator' },
      { title: 'Secrets Management', href: '/docs/platform-components/secrets-management' },
      { title: 'Persistent Storage', href: '/docs/platform-components/persistent-storage' },
      { title: 'Monitoring', href: '/docs/platform-components/monitoring' },
      { title: 'Log Aggregation', href: '/docs/platform-components/log-aggregation' },
  ...
  },
  {
    title: 'Guides',
    links: [
      { title: 'Production Checklist', href: '/docs/guides/production-checklist' },
    ],
  },
  {
    title: 'Talos Manager',
