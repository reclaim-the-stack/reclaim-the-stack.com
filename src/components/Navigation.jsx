...
export const navigation = [
  ...
  },
  {
    ...
    links: [
      ...
      { title: 'Redis', href: '/platform-components/redis-operator' },
      { title: 'Elasticsearch', href: '/platform-components/elasticsearch-operator' },
      { title: 'Secrets Management', href: '/platform-components/secrets-management' },
      { title: 'Persistent Storage', href: '/platform-components/persistent-storage' },
      { title: 'Monitoring', href: '/platform-components/monitoring' },
      { title: 'Log Aggregation', href: '/platform-components/log-aggregation' },
      { title: 'Service Mesh', href: '/platform-components/service-mesh' },
    ],
  },
  {
    title: 'Talos Manager',
