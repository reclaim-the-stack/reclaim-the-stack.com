  ...
  return (
    <div className="group relative flex h-12">
      ...
      <input
        ref={inputRef}
        className={clsx(
          'flex-auto appearance-none bg-transparent pl-10 text-stone-900 outline-none placeholder:text-stone-500 focus:w-full focus:flex-none dark:text-white sm:text-sm [&::-webkit-search-cancel-button]:hidden [&::-webkit-search-decoration]:hidden [&::-webkit-search-results-button]:hidden [&::-webkit-search-results-decoration]:hidden',
      ...
      {autocompleteState.status === 'stalled' && (
        <div className="absolute inset-y-0 right-3 flex items-center">
          <LoadingIcon className="h-5 w-5 animate-spin stroke-stone-200 text-stone-900 dark:stroke-stone-800 dark:text-sunrise-400" />
        </div>
      )}
    </div>
  )
    ...
    >
      ...
      >
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 bg-stone-400/25 backdrop-blur-sm dark:bg-black/40" />
        </Transition.Child>
        ...
        <div className="fixed inset-0 overflow-y-auto px-4 py-4 sm:px-6 sm:py-20 md:py-32 lg:px-8 lg:py-[15vh]">
          ...
          >
            <Dialog.Panel className="mx-auto overflow-hidden rounded-lg bg-stone-50 shadow-xl ring-1 ring-stone-900/7.5 dark:bg-stone-900 dark:ring-stone-800 sm:max-w-xl">
                  ...
                  >
                    {autocompleteState.isOpen && (
                      <>
                        ...
                        />
                        <p className="flex items-center justify-end gap-2 border-t border-stone-100 px-4 py-2 text-xs text-stone-400 dark:border-stone-800 dark:text-stone-500">
                          Search by{' '}
                          <AlgoliaLogo className="h-4 fill-[#003DFF] dark:fill-stone-400" />
                        </p>
                      </>
                    )}
                  </div>
