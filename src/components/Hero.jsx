...
export function Hero() {
  return (
    <div className="text-center w-full text-xl lg:text-2xl text-stone-700 dark:text-stone-200">
      <Image className="mx-auto mt-10 mb-16 w-[250px]" src="/reclaim-the-stack.png" alt="Reclaim the Stack" width="250" height="134" />
      ...
      <Button className="mt-10 mr-5 text-xl sm:text-lg mb-8" href="/docs/kubernetes-platform/introduction">Read the Documentation</Button>
      <Button className="text-xl sm:text-lg" variant="text" href="https://discord.gg/v23eA4FMPC">Join the Discord Server</Button>
    </div>
  )
}