...
export const Header = forwardRef(function Header({ className }, ref) {
  ...
  return (
    <motion.div
      ...
      className={clsx(
        className,
        'w-screen top-0 z-50 h-14 items-center justify-between gap-12 px-4 transition pt-4 h-[68px] border-b border-sunrise-300/10 sm:px-6 lg:px-0 lg:z-30',
    ...
    >
      <div className="flex lg:w-[70rem] mx-auto justify-between items-center">
        <Link className="hidden lg:block" href="/" aria-label="Home">
          <h1 style={{ fontFamily: "Matiz" }} className="text-2xl text-sunrise-500">RECLAIM THE STACK!</h1>
        </Link>
        <Search />
