  ...
  return (
    <button
      ...
      className={clsx(
        ...
        copied
          ? 'bg-sunrise-400/10 ring-1 ring-inset ring-sunrise-400/20'
    ...
    >
      ...
      <span
        aria-hidden={!copied}
        className={clsx(
          'pointer-events-none absolute inset-0 flex items-center justify-center text-sunrise-400 transition duration-300',
          !copied && 'translate-y-1.5 opacity-0'
        )}
      >
        Copied!
            ...
            <Tab
              className={clsx(
                ...
                childIndex === selectedIndex
                  ? 'border-sunrise-500 text-sunrise-400'
...
export function CodeGroup({ children, title, ...props }) {
  ...
  return (
    <CodeGroupContext.Provider value={true}>
      <Container
        {...containerProps}
        className="not-prose my-6 overflow-hidden rounded-2xl bg-stone-900 shadow-md dark:ring-1 dark:ring-white/10"
      >
