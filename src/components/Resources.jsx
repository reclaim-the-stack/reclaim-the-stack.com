...
function ResourceIcon({ icon: Icon }) {
  return (
    <div className="flex h-7 w-7 items-center justify-center rounded-full bg-stone-900/5 ring-1 ring-stone-900/25 backdrop-blur-[2px] transition duration-300 group-hover:bg-white/50 group-hover:ring-stone-900/25 dark:bg-white/7.5 dark:ring-white/15 dark:group-hover:bg-sunrise-300/10 dark:group-hover:ring-sunrise-400">
      <Icon className="h-5 w-5 fill-stone-700/10 stroke-stone-700 transition-colors duration-300 group-hover:stroke-stone-900 dark:fill-white/10 dark:stroke-stone-400 dark:group-hover:fill-sunrise-300/10 dark:group-hover:stroke-sunrise-400" />
    </div>
  )
}
