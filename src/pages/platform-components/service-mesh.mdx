...
Any pod with the label `linkerd.io/inject: enabled` will automatically get a `linkerd` sidecar container injected into and start proxying all network traffic. Our default deployment templates
